...
La vérification des mises à jour des dépendances devrait être effectuée régulièrement. Cela peut gagner beaucoup de temps, en évitant les bogues en raison du code dépendant des fonctionnalités obsolètes. Services such as [David](https://david-dm.org/) are available for dependency management.
