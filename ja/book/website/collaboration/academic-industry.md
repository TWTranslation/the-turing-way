...
| 前提条件                                                                      | 重要度    | スキルレベル | メモ                                                                                                          |
| ------------------------------------------------------------------------- | ------ | ------ | ----------------------------------------------------------------------------------------------------------- |
| {ref}`Project Design <pd-overview>`                                       | 役に立つもの | 初級者    | This guide has lots of useful information that would be helpful to consider when starting a collaboration   |
| {ref}`Community Managers: Overview<cl-infrastructure-community-managers>` | 役に立つもの | 初級者    | An overview of the Community Manager Role                                                                   |
| {ref}`Guide to Planning a Community<cl-new-community-guide>`              | 役に立つもの | 初級者    | The Guide to Planning a Community are helpful context for the Community Building Subchapter in this section |
