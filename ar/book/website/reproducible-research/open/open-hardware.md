...
- A **Bill of Materials** (BOM): A list or spreadsheet describing part numbers, putative suppliers, costs, and a short description.
  اجعل من السهل معرفة أي عنصر في فاتورة المواد يقابل أي مكون في ملفات التصميم الخاصة بك: استخدم مطابقة مرجع المصممين في كلا المكانين، وفر رسم بياني يبين الجزء الذي يذهب إليه, و غير ذلك إشرح المراسلات بطريقة أخرى،
...
- **Assembly instructions**. To help others make and modify your hardware design, you should provide instructions for going from your design files to the working physical hardware.
  ...
  وفي كلتا الحالتين، من المفيد تقديم عبارات أو نصوص تشرح ما يظهر في كل صورة ولماذا هي مفيدة،
...
- **Software and firmware**: You should share any code or firmware required to operate your hardware.
  هذا سيسمح للآخرين باستخدامه لجهازهم أو تعديله جنبا إلى جنب مع تعديلاتهم على جهازك،
  قم بتوثيق العملية المطلوبة لإنشاء برنامجك ، بما في ذلك الروابط إلى الوظائف الأساسية المرتبطة بها (على سبيل المثال ، مكتبات أو أدوات الطرف الثالث)،
