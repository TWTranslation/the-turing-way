...
# Livro Dash Documento Compartilhado Principal

_This template can be shared via a HackMD page to provide all information centrally for the Book Dash participants.
The access permission can be set so that the notes can be read by everyone and edited by signed-in users._
