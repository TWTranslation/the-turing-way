...
- A **Bill of Materials** (BOM): A list or spreadsheet describing part numbers, putative suppliers, costs, and a short description.
  Facilite dizer qual item na fatura de materiais corresponde a qual componente nos arquivos de design: use designers de referência correspondentes em ambos os lugares, fornecer um diagrama indicando qual parte vai para onde, ou de outra forma, explicar a correspondência.
...
- **Assembly instructions**. To help others make and modify your hardware design, you should provide instructions for going from your design files to the working physical hardware.
  ...
  De qualquer forma, é bom fornecer legendas ou texto que explique o que é mostrado em cada imagem e por que é útil.
...
- **Software and firmware**: You should share any code or firmware required to operate your hardware.
  Isso permitirá que outros o usem com seu hardware ou o modifiquem juntamente com as modificações no seu hardware.
  Documente o processo necessário para construir seu software, incluindo links para quaisquer dependências (por exemplo, bibliotecas ou ferramentas de terceiros).
