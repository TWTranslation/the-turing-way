...
En tant que dépôt Git stocke chaque version de chaque fichier qui lui est ajouté, les grands fichiers qui subissent des modifications régulières peuvent gonfler considérablement la taille d'un projet.
