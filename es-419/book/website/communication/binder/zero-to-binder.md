...
<code>Hola de Binder!</code> debe imprimirse en el terminal.

(z2b-background-1)=

### What's happening in the background? - Part 1

Era fácil empezar, pero nuestro entorno es barebones - ¡Añadamos una <strong x-id="1">dependencia</strong>!

- Comparte la URL <strong x-id="1">https://mybinder.org/v2/gh/YOUR-USERNAME/my-first-binder/HEAD</strong> directamente
...
Con el fin de soportar el acceso a archivos privados, necesitarías crear un despliegue local de <a href="https://binderhub.readthedocs.io">BinderHub</a> donde puedes decidir las compensaciones de seguridad tú mismo.
