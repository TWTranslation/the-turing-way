...
| ---------------------------------------------------- | ------- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| {ref}`Section Code Reviewing Process <rr-reviewing>` | مفيدة   |             | We see code review as a part of peer review process                                                                                                                    |
| {ref}`Section Research Data Management <rr-rdm>`     | مفيدة   |             | A part of review process involves reviewing the data on which the publication is based. Knowledge of Research Data Management can help with evaluation |
| {ref}`Guide for Collaboration <cl>`                  | مفيدة   |             | We see review as a form of collaboration                                                                                                                               |
