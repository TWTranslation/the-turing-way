...
Esto se debe a que la división de enteros se aplica a enteros en Python 2, pero la división (normal) se aplica a todos los tipos, incluyendo enteros, en Python 3.

Therefore this simple script returns _different_ answers depending on the computational environment in which it is run.
Usar la versión incorrecta de Python es fácil de hacer, y demuestra cómo una pieza de código perfectamente válida puede dar diferentes resultados dependiendo de su entorno.
