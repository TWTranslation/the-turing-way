...
Bunlar başarısız olursa, düzeltilene kadar ek test seviyelerine geçmenin bir anlamı yoktur.

[](#rr-testing-unittest): A level of the software testing process where individual units of a software are tested. Amaç, yazılımın her bir biriminin tasarlandığı şekilde çalıştığını doğrulamaktır.

[](#rr-testing-types-integrationtest): A level of software testing where individual units are combined and tested as a group.
Bu test seviyesinin amacı, entegre üniteler arasındaki etkileşimdeki hataları ortaya çıkarmaktır.

[](#rr-testing-systemtest): A level of the software testing process where a complete, integrated system is tested.
Bu testin amacı, sistemin bir bütün olarak verilen girdiler için doğru çıktılar verip vermediğini değerlendirmektir.

[](#rr-testing-acceptance-regression): A level of the software testing process where a system is tested for acceptability.
Bu testin amacı, sistemin proje gerekliliklerine uygunluğunu değerlendirmek ve belli bir amaç için kabul edilebilir olup olmadığını değerlendirmektir.
