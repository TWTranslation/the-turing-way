...
إن التفكير في قابلية التكرار (Reproducibility) من بداية مشروعك هو أفضل طريقة لتوفير الوقت وتحقيق أقصى استفادة من الأدوات المتاحة،
...
A human-centered approach in the context of the research project can lead to a better development process, maintenance, and future extension of our work. علاوة على ذلك ، سيساعد ذلك في تحسين جودة تصميم المشروع المستقبلي حيث يمكننا تعلم الدروس مما نجح وما يمكن تحسينه.
...
تساعد ممارسات تصميم المشروع في توفير التوجيه وتحديد التوقعات الواضحة من خلال نقاش المعايير وتمكين أعضاء المشروع على مختلف مستويات التسلسل الهرمي من التعاون على نحو منصف،
...
قم بإنشاء سجل (repository) مشترك ليكون الوصول إلى المعلومات والمستندات المختلفة المتعلقة بمشروعك سهلا،إذ يمكن أن يكون سجل هذا المشروع متاحًا بشكل مفتوح للجميع إذا كنت تقوم بتطوير مشروع مفتوح المصدر ، أو يمكن مشاركته فقط مع المتعاونين لديك،
...
وفي الفصل التالي ، نناقش كيف يتيح تصميم المشروع التواصل الجيد والتعاون في البحث،
وفي الفصول اللاحقة، نصف مختلف الأساليب والأدوات لضمان قابلية تكرار (Reproducibility) البحوث.
