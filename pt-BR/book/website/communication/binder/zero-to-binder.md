...
<code>Olá de Binder!</code> será impresso no terminal.

(z2b-background-1)=

### What's happening in the background? - Part 1

Foi fácil de começar, mas nosso ambiente é desbones - vamos adicionar uma <strong x-id="1">dependência</strong>!

- Compartilhe a URL <strong x-id="1">https://mybinder.org/v2/gh/YOUR-USERNAME/my-first-binder/HEAD</strong> diretamente
...
Veja <a href="https://mybinder.readthedocs.io/en/latest/using/config_files.html#postbuild-run-code-after-installing-the-environment">exemplo <code>postBuild</code> do Binder</a> para mais usos do <code>script postBuild</code>.
...
Para apoiar o acesso a arquivos privados, Você precisa criar um deploy local do <a href="https://binderhub.readthedocs.io">BinderHub</a> onde possa decidir o trading com segurança.
