...
Um estilo de codificação é um conjunto de convenções sobre como formatar código.
Por exemplo, como você nomeia suas variáveis?  Você usa espaços ou tabulações para indentação?  Onde você coloca os comentários?
Usar o mesmo estilo de forma consistente em todo o código torna a leitura mais fácil.
Código que é fácil de ler também é mais fácil de entender, tanto para você quanto para possíveis colaboradores.
Portanto, seguir um estilo de codificação reduz o risco de erros e facilita a colaboração no desenvolvimento de software.
...
As directrizes de estilo diferem entre organizações, línguas e ao longo do tempo.
Even the Python style guide Python Enhancement Proposal 8 (PEP 8) has had numerous revisions since it was released in 2001.
Você deve escolher um framework que seja melhor para os seus propósitos: seja para o seu benefício ou o benefício dos outros.
Também é importante mantermo-nos consistentes (e não consistentemente inconsistentes)!
