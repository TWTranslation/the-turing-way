...
_**This guide covers topics related to effective communication in research.**_
...
ターゲットオーディエンスに共鳴し、影響を与えることができるように、責任を持って自分の洞察を伝える方法はたくさんあります。
...
このガイドでは、 我々は、科学的なデータ分析に気づいていないかもしれない異なる聴衆にデータに基づく結果を効果的に伝えるための章と指導への貢献を歓迎します。
