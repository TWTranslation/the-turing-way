...
_This template can be used for shared note-taking and information exchange in HackMD during the book dash events.
The access permission can be set so that the notes can be read by everyone and edited by any signed-in users._
