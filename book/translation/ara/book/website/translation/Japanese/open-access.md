...
し か し 、 新 し い 知識 は 、 現在 の 奨 学 金 を 合成 し 、 そ の 上 に 構築 す る こ と に て 構築 さ れ في مطلع القرن الحادي والعشرين ، الوصول المفتوح [{1 term} ` تأسست حركة>] ، بشكل أساسي من خلال <a href="https://www.budapestopenaccessinitiative.org/"> مبادرة الوصول المفتوح في بودابست </ 2> وإعلان برلين بشأن الوصول المفتوح.
طلب السياق. ブダペストオープンアクセスイニシアチブの引用文は次のとおりです。</p>

<blockquote spaces-before="0">
  <p spaces-before="0">「私たちは、公共のインターネット上で無料で利用できることを意味し、すべてのユーザーが読むことを許可します。 これらの記事の全文へのダウンロード、コピー、配布、印刷、検索、またはリンク... 彼は複製と頒布のみに制約をかけていますこの領域における著作権の唯一の役割は 著者に自分の仕事の完全性と正しく認められる権利を与えるべきだ」</p>
</blockquote>

<p spaces-before="0">学術文献の約28%がオープンアクセス {cite}<code>Piwowar2018stateofOA`であり、2020年には従来の購読チャンネル {cite}よりも多くの出力がオープンアクセスチャンネルを通じて公開されました`Dimensions2021openaccesssurpass`.
...
. プ リ プ リ ン ト サ ー バ ー は 、 物理 科学 の た め に 1991 年 に 設立 さ ま し た على الأرجح نظرًا لعدم كفاءة المجلات التقليدية ، نمت خوادم ما قبل الطباعة للتخصصات الأخرى بشكل كبير على مدى السنوات الخمس الماضية ، مع ظهور [ bioRxiv ](https://www.biorxiv.org/) و [ medRxiv ](https://www.medrxiv.org/) و [ ChemRxiv ](https://chemrxiv.org/engage/chemrxiv/public-dashboard) و [ SocArXiv ](https://osf.io/preprints/socarxiv) وغيرها الكثير. Preprintsにより、研究者はすぐに結果を出して、論文をジャーナルに提出する前に原稿に関するフィードバックを得る機会を与えることができます。 いくつかのジャーナルは、「事前発行」とみなされるプリプリントサーバーに既に投稿されている場合、論文を提出できないものもあります。 しかし... プレプリントの人気は多くの出版社にプリプリントを受け入れさせています eLifeのような日誌の場合は、 {cite}`life2020preprints` を積極的に奨励してください。 プレプリントの詳細については、 [ASAPBio](https://asapbio.org/preprint-info) をご覧ください。
