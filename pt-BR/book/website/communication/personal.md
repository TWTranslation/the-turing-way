...
| Pré-requisito   | Importância | Skill Level | Notas                                                                                                  |
| --------------- | ----------- | ----------- | ------------------------------------------------------------------------------------------------------ |
| [](#rr-open)    | Útil        | Beginner    | An understanding of open research practices is useful for creating a personal website. |
| [](#cm-blogs)   | Útil        | Beginner    | Blogs for research communication can be part of a personal website.                    |
| [](#cm-citable) | Útil        | Beginner    | Gain understanding of how to make your research objects citable.                       |
