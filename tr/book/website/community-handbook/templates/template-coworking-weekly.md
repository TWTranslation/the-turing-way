...
# Haftalık Ortak Çalışma Çağrısı Şablonu

_A permanent document exists in the HackMD: [https://hackmd.io/\@malvikasharan/TW-coworking](https://hackmd.io/\@malvikasharan/TW-coworking) that is updated every Monday with the dates and times for the respective week._
...
_If you can't join from the beginning of the hour, please let the host know by contacting on [Gitter](https://gitter.im/the-turing-way/the-turing-way) or via email._
...
### Sign up below to indicate you will join on particular dates. _Time is given in BST_

_Please ping the host of this call on Gitter if you signed up but no longer can join_
