...
翻訳ワークフローとは、翻訳プロセス中に貢献者が従うべきフェーズのみを指すものではありません。
代わりに、成功かつ持続可能な翻訳プロジェクトにつながる一連の側面について言及します。

現在の翻訳管理システムは Crowdin です。
...
- **Review the Translation Guidelines.**
  - What should _not_ be translated for consistency and structural integrity.
