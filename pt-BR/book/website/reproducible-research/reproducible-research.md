...
# Guia para Pesquisa Reprodutível

_**This guide covers topics related to skills, tools and best practices for research reproducibility.**_
...
While it is absolutely fine for us each to use different words, it will be useful for you to know how _The Turing Way_ defines _reproducibility_ to avoid misunderstandings when reading the rest of the handbook.
...
Suas contribuições para melhorar esses capítulos, adicionar outros conceitos importantes em reprodutibilidade e empoderar pesquisadores e pesquisadoras a trabalharem de forma reprodutível desde o início são muito bem-vindas.
