...
هذه قائمة مرجعية لإضافة ترخيص (license) إلى مستودع المشروع الخاص بك.

- انتقل إلى السجل الخاص بك (الكمبيوتر المحلي أو السجل عبر الإنترنت على جيت هاب (GitHub)/جيت لاب (GitLab)/بيت باكات (BitBucket)).
...
يمكنك قراءة المصادر الإضافية لمعرفة المزيد حول تراخيص البرمجيات.
