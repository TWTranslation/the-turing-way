...
# Citando tus propios objetos de investigación

Cuando cite sus propios objetos de investigación, es importante considerar el tipo de objeto de investigación al que se refiere.
Aquí ofrecemos explicaciones para citar datos, muestras físicas y software.
...
La cita de datos es importante porque facilita el acceso, la transparencia y potencialmente la reproducibilidad, la reutilización. y crédito para los investigadores, y podría ser requerido cuando los datos son compartidos bajo una licencia que requiere citas (por ejemplo, CC-BY). For more information check the chapter about {ref}`rr-licensing`.

La citación de datos también proporciona reconocimiento y visibilidad a los repositorios que comparten datos.
...
## Citando muestras físicas

Cuando se comparten resultados relacionados con muestras físicas (como material arqueológico, muestras genómicas), lo ideal es asignar un identificador persistente para rastrear las muestras y sus datos asociados.
...
Dependiendo de la revista, también puede incluir una Declaración de disponibilidad de Software/Código. En esta sección, puedes describir dónde se puede encontrar el código desarrollado durante la investigación presentada en el papel, similar a cómo proporcionaría información sobre la disponibilidad de datos.
