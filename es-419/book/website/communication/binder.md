...
rg es un servicio completamente público y no debe proporcionar ninguna información sensible a una instancia de Binder que se ejecute bajo ninguna circunstancia.
