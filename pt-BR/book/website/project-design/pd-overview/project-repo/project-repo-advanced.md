...
| ----------------------------------------- | ----------- | ----------------------------------------------- |
| {ref}`Version Control<rr-vcs>`            | Útil        | Knowledge of using git for version control      |
| {ref}`Open Research<rr-open>`             | Útil        | Components are part of the compendium           |
| {ref}`Reproducible Environments<rr-renv>` | Útil        | Can be used to make the compendium reproducible |
