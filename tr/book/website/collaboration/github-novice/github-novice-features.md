...
# Daha fazla GitHub özelliği kullanma

Artık deponuz kurulduğuna göre, ona daha fazla şey eklemeye ve kullanışlı özelliklerinden bazılarını kullanmaya hazırsınız.

## Daha fazla klasör (dizin), dosya ve yorum ekleme

- "Dosya ekle" butonuna tıklayarak ve dosya yükleyerek veya yeni bir tane oluşturarak deponuza daha fazla dosya ekleyebilirsiniz.
