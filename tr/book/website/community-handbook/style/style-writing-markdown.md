...
_The Turing Way_ book is intended to be only _lightly_ opinionated.
...
Instead of the first abbreviation in the table for _exempli gratia_, which can sometimes read aloud as ‘egg’ by screen reading software, please use ‘for example’ or ‘such as’ or ‘like’ or ‘including’ - whichever works best in the specific context.

Instead of the second abbreviation in the table for _et-cetera_ to indicate open ended list, please start the list with words like ‘for example’ or ‘such as’ or ‘like’ or ‘including’.

Instead of third abbreviation in the table for _id est_ that is often used to clarify a sentence, try (re)writing sentences to avoid the need to use it.
