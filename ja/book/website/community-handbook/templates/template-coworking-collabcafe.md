...
- コラボカフェに入ることはできませんが、一緒に仕事をしたいですか? Check out the co-working calls during the week: https://hackmd.io/\\@malvikasharan/TW-coworking
...
_If you have an idea for a topic you'd like to discuss in a breakout room, please add it below and put your name next to it. すでに提案されているトピックのいずれかを気に入った場合は、そのトピックの横にあなたの名前を追加してください。 チームワークが夢の仕事になります。 For more information about breakout rooms see [the description on The Turing Way](https://book.the-turing-way.org/community-handbook/coworking/coworking-collabcafe.html#breakout-rooms#breakout-rooms)._
