...
- [Open Working](https://openworking.wordpress.com/) by 4TU.ResearchData & TU Delft Library and Data Stewards. Usa WordPress.
...
- [Amara](https://amara.org) or [Otter](https://otter.ai/) can be used to generate your subtitles.
  Plataformas de videoconferência, como Zoom ou Google meet também possuem legendas.
