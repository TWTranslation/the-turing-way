...
A README file is \`\`\`
_"a text file that introduces and explains a project. It contains information that is commonly required to understand what the project is about."_
...
A changelog is a plain text file that contains a record of what _notable_ changes are made between versions of software.  
...
defining a _code of conduct_ is necessary to create and maintain a collaboration environment that promotes participation and fosters the exchange of ideas,
