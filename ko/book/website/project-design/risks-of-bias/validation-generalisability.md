...
These should then _all_ be reported on, without simply cherry-picking the ones which portray the best performance.
...
Such a model is completely useless, and this would be obvious if we used a _balanced accuracy_, which would give a score of 50%.
