...
Since, in _The Turing Way_, we aim to promote open and reproducible ways of working, in this subchapter, we have explained free and open source software (FLOSS) licensing.
...
حيث تندرج البرامج التي لا يُسمح لك بنسخها أو تعديلها ضمن هذه الفئة ، كما هو الحال مع البرامج ذات قيود الاستخدام ، على سبيل المثال ، "للاستخدام البحثي فقط" أو "للاستخدام غير التجاري فقط".
...
- Freedom 1: The freedom to study how the program works, and change it, so it does your computing as you wish.
  و الوصول إلى مصدر النص البرمجي  هو شرط مسبق لذلك.
...
<table>
    ...
    <tbody>
        <tr>
        <td>الترخيص العام (GPL)<sup>1</sup>رخصة التطوير والتوزيع المشتركة (CDDL)<sup>2</sup></td>
        <td>أقل رخصة عامة  (LGPL)<sup>3</sup> رخصة موزيلا العامة (MPL)<sup>4</sup></td>
        <td>بي إس دي (BSD)<sup>5</sup> معهد ماساتشوستس للتكنولوجيا (MIT)<sup>6</sup> أباتشي (Apache)</td>
            <td>بحث فقط: لا يوجد نسخ&nbsp;، لا تعديل&nbsp;</td>
        </tr>
    </tbody>
    <caption>
      <div class="footnote"><sup>1</sup>GPL: GNU General Public License <sup>2</sup>CDDL: Common Development and Distribution License <sup>3</sup>LGPL: GNU Lesser General Public License <sup>4</sup> MPL: Mozilla Public License <sup>5</sup> BSD: Berkeley Software Distribution <sup>6</sup> MIT: Massachusetts Institute of Technology
      </div>
