...
- [Open Working](https://openworking.wordpress.com/) by 4TU.ResearchData & TU Delft Library and Data Stewards. Utilise WordPress.
...
- [Amara](https://amara.org) or [Otter](https://otter.ai/) can be used to generate your subtitles.
  Les plateformes de vidéoconférence telles que Zoom ou Google se rencontrent ont également des légendes.
