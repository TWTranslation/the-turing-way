...
# Gelişmiş GitHub özellikleri

## Daha fazla işbirliği

GitHub, işbirliği yapmayı, ekip oluşturmayı ve yönetmeyi kolaylaştırır.
Ekip ayarlarını kullanarak kuruluşunuza veya projenize ortak çalışanlar ekleyebilir ve izinleri yönetebilirsiniz.
Branch, pull request ve merge imkanları; akıcı, sürüm kontrollü ve ekip halinde çalışmayı daha da kolaylaştırır.
...
## Projenizi bir web sayfasına dönüştürün

GitHub deponuz, ayarlarda GitHub sayfalarını etkinleştirerek projeniz için bir web sayfasına dönüştürülebilir.
...
## Depoyu çevrimiçi bir platforma bağlayın

### Açık Bilim Çerçevesi(Framework)
...
Tüm proje çalışmalarınız için tek durak noktası gibidir.
...
Kodunuzu alıntılanabilir hale getirmek açık bilimin önemli bir parçasıdır.
