...
Les données ici sont utilisées comme un terme générique pour englober tous les objets numériques.
Le RDM est un élément essentiel de la recherche reproductible.
...
Les données doivent être stockées à plusieurs endroits et sauvegardées régulièrement afin de prévenir la perte ou la corruption des données.
La description claire des données à l'aide de la documentation et des métadonnées garantit que les autres savent y accéder. utiliser et réutiliser vos données et permettre également de décrire les conditions de partage et de publication des données.
