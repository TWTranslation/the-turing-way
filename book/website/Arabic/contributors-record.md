...
*ويتلقى المجتمع المحلي المعني بطريق تورينغ مساهمات عينية من أعضاء يدعمهم أصحاب العمل أو المشاريع أو المنظمات من أجل مشاركتهم. وتنطبق هذه المساهمات عندما يتعاون عضو واحد أو عدة أعضاء من مشروع أو منظمة على بناء الموارد والمحافظة عليها في طريق التوفيق. These contributions also include projects that build upon The Turing Way resources or collaborate with The Turing Way team members in various capacities. ونحن ننوه بكل عضو من هؤلاء الأعضاء المساهمين على حدة وندرج ملامحهم تحت بند ”المنظمات والمشاريع المتعاونة“.*

## [جامعة ديلفت للتكنولوجيا - كلية العلوم التطبيقية](https://www.tudelft.nl/en/faculty-of-applied-sciences)

وكلية العلوم التطبيقية هي أكبر جامعة للتكنولوجيا في دلفت وتركز على إيجاد حلول مبتكرة لبعض المشاكل التي يواجهها المجتمع. • تطوير المعارف الأساسية اللازمة لدعم التطورات التقنية التي يمكن استخدامها على نطاق واسع في المجتمع بأسره. In ensuring that this knowledge can be shared efectively with the wider society, the Faculty values the sharing of data and code and has a [Research Data Management policy](https://www.tudelft.nl/en/library/research-data-management/r/policies/tu-delft-faculty-policies/) in place since 2020. In this effort, the contributions from the Faculty of Applied Sciences have mainly focused on the Reproducible Research Chapter of _The Turing Way_.
...
والمركز الهولندي للعلوم الإلكترونية هو المحور الوطني الهولندي لتطوير وتطبيق البرمجيات والطرائق الشاملة للمجالات بالنسبة للأوساط العلمية. Their main goal is to enable scientists with varying computing experience to fully utilize the potential of the available e-infrastructure and allow them to achieve otherwise unreachable scientific breakthroughs. ويمول المركز الهولندي للعلوم الإلكترونية في المقام الأول مجلس البحوث الوطني والمنظمة الوطنية الهولندية للهياكل الأساسية الإلكترونية.

مركز العلوم الإلكترونية الهولندي يحتفظ بـ [دليله الخاص](https://guide.esciencecenter.nl/) لتطوير البرمجيات القابلة للتكرار. The focus of the eScience center guide has a big overlap with _The Turing Way_ and therefore it makes sense to avoid duplicating efforts. The eScience center contributes to _The Turing Way_ in the areas which are relevant for the eScience guide. The eScience guide points to _The Turing Way_ in when information would otherwise be duplicated.
...
* More information:
> أنا مؤيد كبير لتحسين جودة البرمجيات. I am really glad that the eScience center is collaborating with _The Turing Way_ in providing guidelines and helping build better research software.
...
* Short bio:
> وحصل ماتيوس على درجة الماجستير في التكنولوجيا الأحيائية مع الفيزياء الأحيائية المتخصصة، في جامعة جاجيلونيان، كراكوف، بولندا. In September 2019 Mateusz joined the Netherlands eScience Center in the role of Community Officer with the focus on communities and training around Research Software Engineering, software best practices and sustainability, and the role of software in open science and reproducible research. Since 2015, Mateusz has been involved in the Carpentries community, first as an instructor, later contributor, mentor, Executive Council member and instructor trainer. وهو يقود أيضا الفرع الهولندي من النجارة ويشارك في الفريق الأساسي لجماعة النجل.
...
* Short bio:
> Susanna-Assunta Sansone is an Associate Director and Principal Investigator at the Oxford e-Research Centre, and an Associate Professor in the Department of Engineering Science of the University of Oxford. وهي أيضا خبيرة استشارية في مجلة سبرينجر ناشر، ومحرر أكاديمي فخري مؤسس لمجلة البيانات العلمية.
...
* Short bio:
> حصل فيليب روكا سيرا على درجة الدكتوراه في البيولوجيا الجزيئية من جامعة بوردو، الانتقال إلى مجال المعلوماتية الحيوية لدى الانضمام إلى فريق المعلوماتية المصغرة في شركة EMBL-EBI، كمبريدج. وهناك، وهو يعمل على إنشاء شركة ArrayExpress، أصبح عضواً نشطاً في العديد من جهود توحيد المعايير الرامية إلى تعزيز رؤية البيانات المفتوحة والعلوم المفتوحة. As part of several EU projects in toxicogenomics and nutrigenomics, he coordinated the development of the ISA project [1], which now continues at the University of Oxford e-Research Centre.
...
تحت اسم التعاون OLS-4 لتورينغ، _طريق التوريق_ يتعاون مع [Open Life Science (OLS)](https://openlifesci.org)، برنامج يساعد الأفراد وأصحاب المصلحة في البحوث على أن يصبحوا سفراء علميين مفتوحين. ويشارك في تأسيس هذا البرنامج كل من باتوت ومالفيكا شاران ويو يهودي. This collaboration offers training and mentoring to interested members from Turing and The Turing Way communities to join the OLS programme individually or in teams. وهي تطور جوانب العلوم المفتوحة في المشاريع التي إما أنها تعمل بالفعل عليها أو تريد تطويرها في المستقبل القريب.

You can see the projects that participated in the second round - [OLS-2](https://openlifesci.org/ols-2/projects-participants/) and the third round - [OLS-3](https://openlifesci.org/ols-3/projects-participants/). تم منح هذا التعاون منحة التدريب عبر الإنترنت لدعم مشاريع تورينج في الجولة الرابعة ([OLS-4](https://openlifesci.org/funders)) وتقاسم المواد علنا في شبكة التدريب Ting.

## [Remote Computational Project Resource](https://isabelbirds.github.io/Remote-Computational-Project-Resource/welcome.html)

هذا المورد بدأته شركة إيزابيل بيدز أثناء وباء COVID-19 لدعم الطلاب الذين تم نقلهم من مشاريع المختبرات الجافة الرطبة إلى مشاريع المختبرات الجافة النائية في غضون مهلة قصيرة. This project includes links to (1) general tutorials for the complete beginner, (2) tutorials for specific analyses or pipelines, (3) free online textbooks, and (4) places to ask for help.
