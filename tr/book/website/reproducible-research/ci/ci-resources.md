...
**Continuous integration:** The process of regularly combining the work of project members into a centralised version. CI olarak da adlandırılır. CI software typically runs tests on the integrated version of a project to identify conflicts and bugs introduced by the integration.

**Build:** A group of jobs. Örneğin, bir yapı, her biri bir projedeki bir programlama dilinin farklı bir sürümünü test eden iki işe sahip olabilir. Bir yapı, tüm işleri bittiğinde tamamlanır.
