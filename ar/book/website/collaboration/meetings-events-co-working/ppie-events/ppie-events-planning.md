...
| {ref}`cl-mec-event-tools`                | مفيدة     | Suggestions for tools that are useful when planning and running events               |
| {ref}`cl-mec-remote-collab-guidelines`   | مفيدة     | Guidance on running remote events                                                    |
| {ref}`cl-new-community-differences`      | مفيدة     | Useful for thinking about how to be inclusive when collaborating with a diverse team |
