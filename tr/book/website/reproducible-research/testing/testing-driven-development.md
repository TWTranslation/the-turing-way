...
Bir projede testlerin ihmal edilmemesini sağlamanın bir yolu, test odaklı geliştirmeyi benimsemektir.
Bu, birim testlerinin koddan önce yazıldığı bir yaklaşımdır.
