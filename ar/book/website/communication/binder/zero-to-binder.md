...
<code>مرحبا من بيندر!</code> يجب طباعته إلى المحطة الطرفية.

(z2b-متوسطة الملفات)=

### What's happening in the background? - Part 1

كان من السهل البدء، لكن بيئتنا هي حبيسة - دعونا نضيف <strong x-id="1">التبعية</strong>!

- شارك رابط <strong x-id="1">https://mybinder.org/v2/gh/YOUR-USERNAME/my-first-binder/HEAD</strong> مباشرة
- Analysing the contents
- Building a Docker image based on your repo
- أثناء الانتظار، BinderHub (الخلفية للبندر) هو:* جلب المستودع الخاص بك من GitHub
  * تحليل المحتويات
...
راجع <a href="https://mybinder.readthedocs.io/en/latest/using/config_files.html#postbuild-run-code-after-installing-the-environment">Binder <code>postBuild</code> على سبيل المثال</a> لمزيد من استخدامات <code>النسخة البريدية</code>.
...
من أجل دعم الوصول إلى الملفات الخاصة، ستحتاج إلى إنشاء نشر محلي لـ <a href="https://binderhub.readthedocs.io">BinderHub</a> حيث يمكنك تحديد المقايضات الأمنية بأنفسنا.
...
خلال هذا البرنامج التعليمي، كنا نستخدم واجهة JupyterLab هذه هي الواجهة الافتراضية لأنواع بيندر المنشأة حديثا.
