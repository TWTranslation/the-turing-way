...
Veuillez ne pas utiliser d'images qui ne sont pas autorisées à être réutilisées.
...
En général, assurez-vous de toujours citer l'image correctement comme dirigé par les propriétaires de l'image.
"Image de l'internet" n'est pas suffisant.
...
Les légendes apparaissent sous la figure.
Elles devraient être courtes et concises et inclure une référence à la source d'où elles proviennent.
En particulier, il est important de décrire la licence sous laquelle l'image est réutilisée.

(figure-ch-style-advanced)=

> Effectuez votre première pull request sur GitHub.
> Illustration du projet _Turing Way_ par Scriberia.
...
- Both `:` and `"` have syntactic meaning for Sphinx.
  Cela signifie qu'il est important de ne pas utiliser ces caractères dans votre texte alt.
