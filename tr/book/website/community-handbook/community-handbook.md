...
_**This is a community handbook that discusses aspects of The Turing Way project that one can use for participating in this community.**_
...
Topluluk El Kitabı bölümü, proje, çalışma yöntemleri ve topluluk katılımını üyelerimiz için adil hale getirebilecek diğer hususlar hakkında bilgi sağlamayı amaçlamaktadır.

Okurlar, yazarlar, katkıda bulunanlar, ortak çalışanlar, düzenleyiciler, yardımcı ve destekçilerden oluşan topluluk üyelerimize inanılmaz derecede minnettarız.
