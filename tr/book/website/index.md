...
Veri bilimini herkes için erişilebilir, anlaşılır ve etkili hale getirmek için birbirinden çok farklı kişileri dahil ediyoruz ve katkıda bulunmalarını destekliyoruz.
...
Bu, herhangi bir bireyin tek başına sağlayabileceğinden daha anlamli bir şey inşa etmek için, bir ekip çalışmasında gerekli olan sosyo-teknik becerilere yatırım yapmak anlamına gelir.

_The Turing Way_ is:

- bir kitap
- bir topluluk
- ve küresel bir işbirliğidir

Kitaptaki içeriği faydalı bulmanızı umuyoruz.
...
Herhangi bir amaç için ihtiyacınız olan şeyi, lütfen tekrar tekrar kullanın.
...
Bölümler araştırma enstitüleri ve üniversiteler, devlet daireleri ve endüstri üyeleri tarafından yazılmış, gözden geçirilmiş ve düzeltilmiştir.
...
Topluluğumuzun her bir üyesinin katkısına değer veriyoruz ve her katılımcının keyifli ve tatmin edici bir deneyim yaşadığından emin olmak istiyoruz.
...
Bu projeyi herkes için gerçekten erişilebilir ve faydalı kılmak için, sizi bu projeye katkıda bulunmaya ve kendi bakış açınızı bu projeye getirmeye davet ediyoruz.
