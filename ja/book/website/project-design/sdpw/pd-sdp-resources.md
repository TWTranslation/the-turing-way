...
- freeCodeCamp's blog post [_Gitignore Explained: What is Gitignore and How to Add it to Your Repo_](https://www.freecodecamp.org/news/gitignore-what-is-it-and-how-to-add-to-repo/)
- Linuxize's blog post on [_Ignoring Files and Directories in Git (.gitignore)_](https://linuxize.com/post/gitignore-ignoring-files-in-git/)
