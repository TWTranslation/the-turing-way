...
Les directives de style diffèrent entre les organisations, les langues et au fil du temps.
Even the Python style guide Python Enhancement Proposal 8 (PEP 8) has had numerous revisions since it was released in 2001.
Vous devez choisir un cadre qui soit le mieux adapté à vos besoins: que ce soit pour votre bénéfice ou pour celui des autres.
Il est également important de rester cohérent (et non pas systématiquement incohérent)!
