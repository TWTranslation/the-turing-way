...
| -------------------------------------------------------------------------------------------- | ------- | ----------- | ----------------------------------------------------------------------------- |
| [Data Governance](https://book.the-turing-way.org/project-design/data-governance)            | مفيدة   | Beginner    | Best practices on how data is collected and managed                           |
| [Research Data Management](https://book.the-turing-way.org/reproducible-research/rdm#rr-rdm) | مفيدة   | Beginner    | Covers how research data can be stored, described and reused. |
| [Managing Sensitive Data Projects](https://book.the-turing-way.org/project-design/sdpm)      | مفيدة   | Beginner    | Tips on managing sensitive data.                              |
