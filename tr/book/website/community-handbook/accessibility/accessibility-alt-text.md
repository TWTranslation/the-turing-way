...
_Cartoon-like sketch of a woman looking through a big file drawer, where documents are arranged systematically indicated by versions. She is smiling and waving at her colleague who is standing next to the file drawer and seems to be checking if everything is ok - gesturing a thumbs-up._
...
> Scriberia tarafından oluşturulmuş _The Turing Way_ projesi göreseli.
> CC-BY 4.0 lisansı altında kullanılır.
