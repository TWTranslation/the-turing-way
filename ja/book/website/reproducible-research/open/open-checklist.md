...
- 他のユーザーに使用権、コピー、変更権を付与するライセンスを含めます。 You can use the {ref}`rr-licensing` chapter to help you pick the most appropriate licence for your project.
...
- 他のユーザーに使用権、コピー、変更権を付与するライセンスを含めます。 You can use [this](https://choosealicense.com/) website to help you pick the most appropriate licence for your project.
