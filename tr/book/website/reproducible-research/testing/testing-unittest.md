...
Amaç, yazılımın her bir biriminin tasarlandığı şekilde çalıştığını doğrulamaktır.
...
Genellikle bir veya birkaç girdiye ve genellikle tek bir çıktıya sahiptir.
