...
يحتوي هذا القسم على قائمة فحص بسيطة للتوصيات لجعل برنامجك أكثر قابلية للاستخدام.
...
ومن الآثار الجانبية اللطيفة لخطي تسلسل العمليات أن ذلك يمكن أن يكون في كثير من الأحيان بمثابة توثيق للخطوات المتخذة.
...
بدلاً من تحديد مسارات الملفات داخل البرامج النصية ، فكر في تمريرها كحجج سطر الأوامر لنصوص أكثر قابلية للتنقل وعامة و قابلة لإعادة الاستخدام.
