...
| --------------------- | ------- | --------------------------------------------------------------------------------------------------- |
| {ref}`er-datahazards` | مفيدة   | Data Hazard labels can be used to highlight specific ethical risks to shareholders. |

(pd-risks-of-bias-summary)=

## ملخص توضيحي لإنشاء سجلات المشروع

[_Risks of bias_](https://www.nhmrc.gov.au/guidelinesforguidelines/develop/assessing-risk-bias#) are opportunities for the results of research to become distorted by limitations within the study design, conduct, and analysis.
...
In this chapter, the word _bias_ predominantly refers to statistical distortion rather than to {ref}`the unfair treatment of societal groups (discrimination) <pd-risks-of-bias-discrimination-bias>`, which is an important topic in its own right.
