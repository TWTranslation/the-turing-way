...
| {ref}`cl-mec-event-tools`                | Útil        | Suggestions for tools that are useful when planning and running events               |
| {ref}`cl-mec-remote-collab-guidelines`   | Útil        | Guidance on running remote events                                                    |
| {ref}`cl-new-community-differences`      | Útil        | Useful for thinking about how to be inclusive when collaborating with a diverse team |
