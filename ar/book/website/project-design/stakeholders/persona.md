...
يهدف هذا الفصل إلى التقاط 'شخصيات<code>مختلفة من الأعضاء أو المستخدمين وفهم 'المسار</code> التي يتخذونها للاتصال بالمشروع أو البقاء في علاقة به.
...
_We welcome you to add your personas and pathways in this chapter to provide more examples from different projects._
